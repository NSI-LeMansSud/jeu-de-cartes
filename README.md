# jeu-de-cartes
Faire des tris sur des jeux de cartes

Voir [tutoPDF](Tri_JeuCartes.pdf) pour découvrir la manipulation et l'affichage des jeux de cartes en Python.
...
- avec ces 10 cartes affichées, faire un tri par ordre décroissant ;
...
- avec ces 8 cartes affichées, faire un tri par ordre croissant ;
...
- avec ces 15 cartes affichées, élimine les 5 cartes les plus faibles ;
...
- mélange aléatoirement un jeu de 52 cartes complet ;
- prend les 15 premières cartes sur le dessus du paquet et les affiche dans l’ordre de tirage des cartes ;
- avec ces 15 cartes affichées, retenir les 10 cartes les plus fortes ;
- affiche ces 10 cartes restantes triées par ordre décroissant dans un emplacement disponible de la fenêtre graphique (méthode par insertion ou par sélection).


**Quelle que soit la version, on programmera les méthodes de tri *par insertion ou par sélection* vues en cours uniquement (pas de tri avec `sort`/`sorted` en Python)**
